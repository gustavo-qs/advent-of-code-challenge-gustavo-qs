...
limit = 30000000 - (70000000 - directories["/"])
valid_dirs = [dir for dir in directories if directories[dir] > limit]
smallest = min(valid_dirs, key=directories.get)

print(directories[smallest])